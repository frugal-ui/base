...
silent! normal! zE
let &fdl = &fdl
let s:l = 1534 - ((50 * winheight(0) + 26) / 52)
...
wincmd w
argglobal
if bufexists(fnamemodify("styles/theme.css", ":p")) | buffer styles/theme.css | else | edit styles/theme.css | endif
balt index.ts
setlocal keymap=
setlocal noarabic
setlocal noautoindent
