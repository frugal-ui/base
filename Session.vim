...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-scrollbar,~/.vim/plugged/coc.nvim,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-bufferline,~/.vim/plugged/vim-prettier,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after
set shiftwidth=4
set smartindent
...
silent only
silent tabonly
cd ~/Development/Projects/FrugalUI/base
...
silent! normal! zE
let &fdl = &fdl
let s:l = 164 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 164
